...
namespace EntityFramework
{
    public static class SqlScripts
    {
        public static void DocumentInsert(Connect a,Company co,CompanyFinancialDetails cfd)
        {
		   ...
		   {31},{32},{33},{34},{35},{36},{37},{38},{39})", co.CUI, co.CUI, cfd.Quarter, cfd.TotalTangibleAssets, cfd.Shares, cfd.TotalCurrentAssets, cfd.Inventories, cfd.Receivables,
           ...
           cfd.TotalRevenues, cfd.TotalExpenses, cfd.GrossProfit, cfd.NetProfit, cfd.NumberOfEmployees, cfd.Year,DateTime.Now
           );
